...
class qrcode {
    ...
    private static function info($data=[]) {
        ...
        $parametros = [ 'content', 'text', 'value', 'chl', 'data', $data ];
        //verifies if the parameters is correct
...
//---- qrtools.php -----------------------------
    ...
    class QRtools {
        ...
        public static function tcpdfBarcodeArray($code, $mode = 'QR,L', $tcPdfVersion = '4.5.037') {
            ...
            $qrTab = phpqr::text($code, false, $eccLevel);
            $size = count($qrTab);
...
//---- qrencode.php -----------------------------
    ...
    class phpqr {
        ...
        private static function png_output($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint=false)  {
